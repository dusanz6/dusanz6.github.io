...
$to = "oleg.vuckovic@proton.me";														// To Address
$toAlt = "";												// Additional Recipients
$from = "forma767upit5698@inexviljuskari.rs";													// From Address
$fromName = "Inex Sajt";											// From Name
...
$smtpHost = "mail.inexviljuskari.rs";											// SMTP Host
$smtpPort = "465";											// SMTP Port
$smtpSecure = "ssl";										// SMTP Use SSL/TLS (empty, ssl or tls)
$smtpUsername = "forma767upit5698@inexviljuskari.rs ";									// SMTP Username
$smtpPassword = "Hgn7Hjn3DbV6dT5b";									// SMTP Password
